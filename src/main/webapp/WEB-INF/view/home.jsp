				...
				<section class="col-lg-7 connectedSortable">
					...
					<div class="box box-success">
						...
						<div class="box-body chat" id="chat-box">
							<!-- chat item -->
							<div class="item">
								<img src="${ctx}/static/AdminLTE/dist/img/user4-128x128.jpg"
							...
							<!-- chat item -->
							<div class="item">
								<img src="${ctx}/static/AdminLTE/dist/img/user3-128x128.jpg"
...
<myscript>
    <script src="${ctx}/static/system/js/test.js"></script>
</myscript>
</html>